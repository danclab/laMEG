...
mcc('-v',...
    ...
    '-N',Nopts{:},...
    '-a',spm('Dir'),...
    '-W','python:spm_standalone',...
    gateway,...
    'spm.m',...
    'spm_BMS.m',...
    'spm_compare_families.m',...
    'spm_eeg_inv_prep_modes_xval.m',...
    'spm_eeg_simulate.m',...
    'spm_mesh_geodesic.m',...
    '/home/bonaiuto/laMEG/lameg/matlab/convert_ctf_fif_to_spm.m',...
    '/home/bonaiuto/laMEG/lameg/matlab/spm_eeg_smoothmesh_multilayer_mm.m',...
    '/home/bonaiuto/laMEG/lameg/matlab/spm_my_defaults.m');